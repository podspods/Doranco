...
Cependant, il éxiste aussi une version de javascript permattant de s'exécuter en dehors du navigateur (diréctement sur la machine) c'est « nodejs ».
...
Directement dans notre balise script :
